...
# Add a sidebar menu
with st.sidebar:
    selected = option_menu(menu_title=None, options=["Predicting Selling Price","Predicting status"] , orientation="vertical")

if selected == "Predicting Selling Price":
        ...
        if submit_button and flag==0:
            ...
            with open(r"D:\vscode\.vscode\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'D:\vscode\.vscode\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"D:\vscode\.vscode\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"D:\vscode\.vscode\s.pkl", 'rb') as f:
...
if selected == "Predicting status":
    # Define the possible values for the dropdown menus
        ...
        with st.form("my_form1"):
            ...
            with col3:    
                st.write(' ')
                citem_type = st.selectbox("Item_Type", item_type_options,key=21)
            ...
            if csubmit_button and cflag==0:      
                with open(r"D:\vscode\.vscode\cmodel.pkl", 'rb') as file:
                    cloaded_model = pickle.load(file)

                with open(r'D:\vscode\.vscode\cscaler.pkl', 'rb') as f:
                    cscaler_loaded = pickle.load(f)

                with open(r"D:\vscode\.vscode\ct.pkl", 'rb') as f:
